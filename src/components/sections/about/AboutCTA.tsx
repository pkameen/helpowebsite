          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-6 max-w-3xl text-4xl font-semibold tracking-tight text-white md:text-5xl">
                Ready to Build a Premium Website or Software System for Your Business?
              </h2>

              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                If you need a premium website, ecommerce platform, ERP, CRM or
                a custom digital solution, HELPO can help you build a system
                that looks professional, works efficiently and supports growth.
              </p>
            </div>
